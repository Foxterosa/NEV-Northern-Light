...
#define CRYOPOD_SPAWN_BONUS	5 MINUTES//Going to sleep in a cryopod takes this much off your respawn time in minutes
#define CRYOPOD_SPAWN_BONUS_DESC	"5 minutes"	//Tells players how long they have until respawn.
